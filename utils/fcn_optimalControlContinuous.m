function [ x, u, energy ] = fcn_optimalControlContinuous( A, B, rho, x0, xT, T )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%       [3] Luppi, Singleton, Hansen, Jamison, Bzdok, Kuceyeski, Betzel, Misic. 
...
%added by ALuppi, adapted from optim_fun.m (confirmed that results are the same):
energy = sum(u'.^2 * nStep); %this is the node-wise energy
end
